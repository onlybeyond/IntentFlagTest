...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static String TAG=makeLogTag(SecondActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText("第二个页");
        Button btnTestOne=(Button)findViewById(R.id.second_btn_test_one);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if(id==R.id.second_btn_test_one){
